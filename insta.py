...
# Bitiş tarihini saat 00:00 olarak belirle
bitis_tarihi = datetime(2025, 2, 27, 0, 0, 0)

# Şu anki tarih ve saat
bugun = datetime.now()

# Kalan süreyi hesapla
kalan_sure = bitis_tarihi - bugun

# Eğer bitiş tarihi geçmişse Tool durur
if kalan_sure.total_seconds() <= 0:
    print("Tool'un süresi doldu! Program kapatılıyor...")
    exit()  # Programı durdurur
else:
    print(f"Tool'un bitmesine {kalan_sure} kaldı.")
...
═══════════════════
🍫 Ad : {user}
📃 Eposta : {user}@gmail.com
🧸 Developer : @lesttqwe | https://t.me/LesttZirve
══════════════════
        '''
        with open('Hit.txt', 'a') as f:
            f.write(ff + '\n')    	
...
def para():
	...
	cookies ={
        ...
        "sessionid":"0ced3ef372a0f239ebb7e6e3a4977f17"
      }
